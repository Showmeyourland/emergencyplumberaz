...
export const CITY_CONTENT: Record<string, CityContent> = {
  ...
  "buckeye": {
    ...
    neighborhoods: ["Sun Valley Parkway area", "Tartesso", "Sundance", "Verrado", "AZ Emergency Plumbing Co. Lakes Golf Club area", "Sienna Hills", "Watson Road corridor", "Buckeye Village", "Palm Valley (Buckeye section)", "Festival Ranch", "Canyon Trails", "Rovey Farm Estates", "Sundance Village", "Alexandria Park", "Kline Ranch"],
    marketStats: {
      medianPrice: "200-270 ppm hardness (very hard)",
